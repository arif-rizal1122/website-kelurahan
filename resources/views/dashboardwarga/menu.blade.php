...
@section('title') Menu Warga @endsection
@section('css')
    <link href="{{ URL::asset('build/libs/jsvectormap/css/jsvectormap.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('build/libs/swiper/swiper-bundle.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('build/css/custom.min.menu.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
    ...
    <div class="container d-flex flex-column min-vh-100 justify-content-center align-items-center py-4 position-relative">
        <img src="{{ URL::asset('assets/img/bannerblue.png') }}" alt="" width="100%">


        <div class="card p-4 w-100 mb-4" style="max-width: 380px;">
            <div class="d-grid gap-3">
                <a href="{{ route('warga.formulir') }}" class="btn btn-danger py-3 d-flex align-items-center menu-button">
                ...
                <a href="{{ route('warga.riwayat') }}" class="btn btn-secondary py-3 d-flex align-items-center menu-button">
                    <div class="d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.2); border-radius: 10px;">
                ...
                <a href="{{ route('warga.notifikasi') }}" class="btn btn-primary py-3 d-flex align-items-center menu-button">
                    <div class="d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.2); border-radius: 10px;">
                ...
                <a href="{{ route('warga.profile') }}" class="btn btn-info text-white py-3 d-flex align-items-center">
                    <div class="d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.2); border-radius: 10px;">
