<div class="modal fade" id="editPendudukModal" tabindex="-1" aria-labelledby="editPendudukModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form id="editPendudukForm" method="POST" action="{{ route('penduduk.update', $penduduk->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nik" class="form-control" id="edit_nik" required value="{{ old('nik', $penduduk->nik) }}" placeholder="Masukkan 16 digit NIK">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="no_kk_sebelumnya" class="form-control" id="edit_no_kk_sebelumnya" placeholder="Masukkan nomor KK sebelumnya jika ada" value="{{ old('no_kk_sebelumnya', $penduduk->no_kk_sebelumnya) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" id="edit_nama" required value="{{ old('nama', $penduduk->nama) }}" placeholder="Masukkan nama lengkap">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="jenis_kelamin" class="form-select" id="edit_jenis_kelamin" required>
                                ...
                                @foreach (\App\Enums\JenisKelamin::cases() as $jenisKelamin)
                                    <option value="{{ $jenisKelamin->value }}" {{ old('jenis_kelamin', $penduduk->jenis_kelamin) == $jenisKelamin->value ? 'selected' : '' }}>
                                        {{ $jenisKelamin->value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" class="form-control" id="edit_email" required placeholder="nama@contoh.com" value="{{ old('email', $penduduk->email) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="agama" class="form-select" id="edit_agama" required>
                                ...
                                @foreach (\App\Enums\Agama::cases() as $agama)
                                    <option value="{{ $agama->value }}" {{ old('agama', $penduduk->agama) == $agama->value ? 'selected' : '' }}>
                                        {{ $agama->value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control" id="edit_tempat_lahir" required value="{{ old('tempat_lahir', $penduduk->tempat_lahir) }}" placeholder="Masukkan kota kelahiran">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="tanggal_lahir" class="form-control" id="edit_tanggal_lahir" required value="{{ old('tanggal_lahir', $penduduk->tanggal_lahir) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="status_kawin" class="form-select" id="edit_status_kawin" required>
                                ...
                                @foreach (\App\Enums\StatusKawin::cases() as $statusKawin)
                                    <option value="{{ $statusKawin->value }}" {{ old('status_kawin', $penduduk->status_kawin) == $statusKawin->value ? 'selected' : '' }}>
                                        {{ $statusKawin->value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="status_keadaan" class="form-select" id="edit_status_keadaan" required>
                                ...
                                @foreach (\App\Enums\StatusKeadaan::cases() as $statusKeadaan)
                                    <option value="{{ $statusKeadaan->value }}" {{ old('status_keadaan', $penduduk->status_keadaan) == $statusKeadaan->value ? 'selected' : '' }}>
                                        {{ $statusKeadaan->value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="warga_negara" class="form-control" id="edit_warga_negara" required value="{{ old('warga_negara', $penduduk->warga_negara) }}" placeholder="Contoh: WNI/WNA">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="pendidikan_terakhir" class="form-select" id="edit_pendidikan_terakhir" required>
                                ...
                                @foreach (\App\Enums\Pendidikan::cases() as $pendidikan)
                                    <option value="{{ $pendidikan->value }}" {{ old('pendidikan_terakhir', $penduduk->pendidikan_terakhir) == $pendidikan->value ? 'selected' : '' }}>
                                        {{ $pendidikan->value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="ayah_nik" class="form-control" id="edit_ayah_nik" placeholder="Masukkan 16 digit NIK ayah jika ada" value="{{ old('ayah_nik', $penduduk->ayah_nik) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="ibu_nik" class="form-control" id="edit_ibu_nik" placeholder="Masukkan 16 digit NIK ibu jika ada" value="{{ old('ibu_nik', $penduduk->ibu_nik) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_ayah" class="form-control" id="edit_nama_ayah" required placeholder="Masukkan nama lengkap ayah" value="{{ old('nama_ayah', $penduduk->nama_ayah) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_ibu" class="form-control" id="edit_nama_ibu" required placeholder="Masukkan nama lengkap ibu" value="{{ old('nama_ibu', $penduduk->nama_ibu) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="hubungan_warga" class="form-select" id="edit_hubungan_warga" required>
                                ...
                                @foreach (\App\Enums\HubunganWarga::cases() as $hubunganWarga)
                                    <option value="{{ $hubunganWarga->value }}" {{ old('hubungan_warga', $penduduk->hubungan_warga) == $hubunganWarga->value ? 'selected' : '' }}>
                                        {{ $hubunganWarga->value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="golongan_darah" class="form-select" id="edit_golongan_darah" required>
                                ...
                                @foreach (\App\Enums\GolonganDarah::cases() as $golonganDarah)
                                    <option value="{{ $golonganDarah->value }}" {{ old('golongan_darah', $penduduk->golongan_darah) == $golonganDarah->value ? 'selected' : '' }}>
                                        {{ $golonganDarah->value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="suku" class="form-control" id="edit_suku" required value="{{ old('suku', $penduduk->suku) }}" placeholder="Contoh: Jawa, Sunda, dll">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status_rekam" class="form-select" id="edit_status_rekam" required>
                                ...
                                @foreach (\App\Enums\StatusRekam::cases() as $statusRekam)
                                    <option value="{{ $statusRekam->value }}" {{ old('status_rekam', $penduduk->status_rekam) == $statusRekam->value ? 'selected' : '' }}>
                                        {{ $statusRekam->value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="ktp_el" class="form-select" id="edit_ktp_el" required>
                                ...
                                <option value="1" {{ old('ktp_el', $penduduk->ktp_el) == '1' ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ old('ktp_el', $penduduk->ktp_el) == '0' ? 'selected' : '' }}>Tidak</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tempat_cetak_ktp" class="form-control" id="edit_tempat_cetak_ktp" placeholder="Contoh: Kantor Kecamatan Setiabudi" value="{{ old('tempat_cetak_ktp', $penduduk->tempat_cetak_ktp) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="tanggal_cetak_ktp" class="form-control" id="edit_tanggal_cetak_ktp" value="{{ old('tanggal_cetak_ktp', $penduduk->tanggal_cetak_ktp) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pekerjaan" class="form-control" id="edit_pekerjaan" required value="{{ old('pekerjaan', $penduduk->pekerjaan) }}" placeholder="Contoh: Guru, Wiraswasta, PNS, dll">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_sekarang" class="form-control" id="edit_alamat_sekarang" rows="2" required placeholder="Masukkan alamat lengkap tempat tinggal saat ini">{{ old('alamat_sekarang', $penduduk->alamat_sekarang) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_sebelumnya" class="form-control" id="edit_alamat_sebelumnya" rows="2" placeholder="Masukkan alamat tempat tinggal sebelumnya jika ada">{{ old('alamat_sebelumnya', $penduduk->alamat_sebelumnya) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="note" class="form-control" id="edit_note" rows="2" placeholder="Informasi tambahan lainnya (opsional)">{{ old('note', $penduduk->note) }}</textarea>
