            ...
            <div class="col-lg-10">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formPengajuanSurat" enctype="multipart/form-data" method="POST" action="{{ route('pengajuan-surat.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-4">
                                <div class="col-md-6">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-3">
                                        ...
                                        <a href="{{ route('menu.warga') }}" class="btn btn-primary">
