                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="suku" class="form-select" id="suku" required>
                            ...
                            <?php $__currentLoopData = $suku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sukuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sukuItem->value); ?>" <?php echo e(old('suku') == $sukuItem->value ? 'selected' : ''); ?>>
...
<?php /**PATH /home/arifrizal/Desktop/bckup/laravel-modern-template/resources/views/penduduk/create.blade.php ENDPATH**/ ?>