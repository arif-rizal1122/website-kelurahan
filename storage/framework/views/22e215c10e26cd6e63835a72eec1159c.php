<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.detail'); ?> Detail Surat Keluar <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Surat <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Detail Surat Keluar <?php $__env->endSlot(); ?>
                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                        <div class="p-3 bg-light rounded mb-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="badge bg-info">Tujuan: <?php echo e($surat->tujuan ?? '-'); ?></span>
                            </div>
                        </div>
                                        ...
                                        <td class="text-dark">
                                            <?php if($surat->tanggal_pengiriman): ?>
                                                <span class="badge bg-soft-info text-info">
                                                    <?php echo e(\Carbon\Carbon::parse($surat->tanggal_pengiriman)->format('d F Y')); ?>
                    ...
                    <div class="mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text text-muted" style="white-space: pre-line;"><?php echo e($surat->isi_surat ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text text-muted" style="white-space: pre-line;"><?php echo e($surat->catatan ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/laravel-modern-template/resources/views/surat/keluar/show.blade.php ENDPATH**/ ?>