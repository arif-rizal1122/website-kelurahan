                    ...
                    <div class="text-center mb-5">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('build/images/logo-light.png')); ?>" alt="Logo SMART LURAH" height="40">
                            </a>
                        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" id="username" name="email" placeholder="Masukkan username">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <a href="<?php echo e(route('password.update')); ?>" class="text-primary fw-medium text-decoration-none fs-13">Lupa password?</a>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Masukkan password" id="password-input">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/laravel-modern-template/resources/views/auth/login.blade.php ENDPATH**/ ?>