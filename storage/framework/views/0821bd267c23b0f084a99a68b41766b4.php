<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.detail'); ?> Detail Penduduk <?php $__env->stopSection(); ?>
            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                        ...
                        <div class="p-3 bg-light rounded mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <?php if($penduduk->status_keadaan): ?>
                                        <span class="badge bg-info ms-1"><?php echo e($penduduk->status_keadaan); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->nama ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-envelope me-2"></i>Email
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->email ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->tempat_lahir ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->agama ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-heart me-2"></i>Status Perkawinan
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->status_kawin ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-flag me-2"></i>Kewarganegaraan
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->warga_negara ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-droplet me-2"></i>Golongan Darah
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->golongan_darah ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-group me-2"></i>Suku
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->suku ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->pendidikan_terakhir ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-briefcase me-2"></i>Pekerjaan
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->pekerjaan ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->alamat_sekarang ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-history me-2"></i>Alamat Sebelumnya
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->alamat_sebelumnya ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>Hubungan dalam Kartu Keluarga
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->hubungan_warga ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-card me-2"></i>No KK Sebelumnya
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->no_kk_sebelumnya ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->nama_ayah ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>NIK Ayah
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->ayah_nik ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-female me-2"></i>Nama Ibu
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->nama_ibu ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>NIK Ibu
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->ibu_nik ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-dark"><?php echo e($penduduk->status_rekam ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-map me-2"></i>Tempat Cetak KTP
                                                </td>
                                                <td class="text-dark"><?php echo e($penduduk->tempat_cetak_ktp ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div>
                            <a href="<?php echo e(route('penduduk.edit', $penduduk->id)); ?>" class="btn btn-warning me-2">
