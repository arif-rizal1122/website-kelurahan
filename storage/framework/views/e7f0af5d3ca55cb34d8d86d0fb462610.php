        ...
        <div class="h-100">
            ...
            <div class="welcome-card mb-4 animate-fadeInUp" style="--delay: 0">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <h2 class="welcome-title text-white">Selamat Pagi, <?php echo e(Auth::user()->role); ?> <?php echo e(Auth::user()->name); ?></h2>
...
<script>
    ...
    var monthlyStats = <?php echo json_encode($monthlyStats, 15, 512) ?>;
    ...
    if (document.getElementById("populationChart")) {
        ...
        var populationData = [];
        var base = <?php echo json_encode($jumlahPenduduk, 15, 512) ?> * 0.9; // Start at 90% of current
        for (var i = 0; i < 12; i++) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/website-kelurahan/resources/views/dashboard.blade.php ENDPATH**/ ?>