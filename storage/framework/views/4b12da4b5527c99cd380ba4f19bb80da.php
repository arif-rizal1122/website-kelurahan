                            ...
                            <table class="table table-borderless table-hover">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-info"><?php echo e($pengajuanSurat->warga->nama ?? '-'); ?> (NIK: <?php echo e($pengajuanSurat->warga->nik ?? '-'); ?>)</td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-file me-2"></i>Jenis Surat
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->jenisSurat->nama ?? '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-calendar me-2"></i>Tanggal Pengajuan
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->tanggal_pengajuan ? $pengajuanSurat->tanggal_pengajuan->format('d-m-Y') : '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-note me-2"></i>Keperluan
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->keperluan ?? '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-info"><?php echo e($pengajuanSurat->tanggal_diproses ? $pengajuanSurat->tanggal_diproses->format('d-m-Y') : '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-user-check me-2"></i>Diproses Oleh
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->user->name ?? '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-calendar-check me-2"></i>Tanggal Selesai
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->tanggal_selesai ? $pengajuanSurat->tanggal_selesai->format('d-m-Y') : '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                            <i class="bx bx-message-alt-error me-2"></i>Keterangan Penolakan
                                        </td>
                                        <td class="text-info"><?php echo e($pengajuanSurat->keterangan_penolakan ?? '-'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-info">
                                        ...
                                        <td class="text-info">
                                            <?php if($pengajuanSurat->file_pendukung): ?>
                                                <a href="<?php echo e(asset('storage/' . $pengajuanSurat->file_pendukung)); ?>" target="_blank">
                                                    Lihat File
                                                </a>
                                            <?php else: ?>
                                                -
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/laravel-modern-template/resources/views/pengajuan/pengajuanSurat/show.blade.php ENDPATH**/ ?>