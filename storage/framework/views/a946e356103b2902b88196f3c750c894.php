            ...
            <div class="card mt-xxl-n5">
                <div class="card-header">
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#historyUser" role="tab">
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                            ...
                            <form action="<?php echo e(route('config.update')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="alamat_kantor" class="form-control" rows="2"><?php echo e(old('alamat_kantor', $config->alamat_kantor ?? '')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <a href="<?php echo e(route('config.index')); ?>" class="btn btn-soft-secondary">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <!--end tab-pane-->
                        <div class="tab-pane" id="historyUser" role="tabpanel">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/laravel-modern-template/resources/views/pages-profile-settings.blade.php ENDPATH**/ ?>