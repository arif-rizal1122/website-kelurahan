            ...
            <div class="col-lg-10">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formPengajuanSurat" enctype="multipart/form-data" method="POST" action="<?php echo e(route('warga.pengajuan')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row g-4">
                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-3">
                                        ...
                                        <a href="<?php echo e(route('warga.menu')); ?>" class="btn btn-primary">
...
</html><?php /**PATH /home/arifrizal/Desktop/bckup/website-kelurahan/resources/views/dashboardwarga/formulir.blade.php ENDPATH**/ ?>