        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('jenis-surat.update', $jenisSurat->id)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"
                                    id="nama" name="nama"
                                    value="<?php echo e(old('nama', $jenisSurat->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    id="code" name="code"
                                    value="<?php echo e(old('code', $jenisSurat->code)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="deskripsi"
                                    name="deskripsi" rows="5" placeholder="Masukkan deskripsi"><?php echo e(old('deskripsi', $jenisSurat->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="template_surat"
                                    name="template_surat" rows="5" placeholder="Masukkan template_surat"><?php echo e(old('template_surat', $jenisSurat->template_surat)); ?></textarea>
                                <?php $__errorArgs = ['deskripsi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/website-kelurahan/resources/views/pengajuan/jenisSurat/edit.blade.php ENDPATH**/ ?>