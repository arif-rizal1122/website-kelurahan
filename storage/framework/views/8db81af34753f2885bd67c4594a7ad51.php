<?php $__env->startSection('title'); ?> Index Surat Keluar <?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                        ...
                        <a href="<?php echo e(route('surat-keluar.create')); ?>" class="btn btn-primary">
                            Tambah Surat Keluar
                        </a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 overflow-auto">
                                                ...
                                                <a href="<?php echo e(route('surat-keluar.edit', $surat->id)); ?>" class="btn btn-sm btn-warning">
                                                    Edit
                                                </a>
