                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->nama ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-envelope me-2"></i>Email
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->email ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->tempat_lahir ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->agama ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-heart me-2"></i>Status Perkawinan
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->status_kawin ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-flag me-2"></i>Kewarganegaraan
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->warga_negara ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-droplet me-2"></i>Golongan Darah
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->golongan_darah ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-group me-2"></i>Suku
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->suku ?? '-'); ?></td>
                                            </tr>
                                            <tr>   
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-group me-2"></i>Status Keadaan
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->status_keadaan ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->pendidikan_terakhir ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-briefcase me-2"></i>Pekerjaan
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->pekerjaan ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->alamat_sekarang ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-history me-2"></i>Alamat Sebelumnya
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->alamat_sebelumnya ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>Hubungan dalam Kartu Keluarga
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->hubungan_warga ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-card me-2"></i>No KK Sebelumnya
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->no_kk_sebelumnya ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->nama_ayah ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>NIK Ayah
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->ayah_nik ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-female me-2"></i>Nama Ibu
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->nama_ibu ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-id-card me-2"></i>NIK Ibu
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->ibu_nik ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-borderless table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-black"><?php echo e($penduduk->status_rekam ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                                                    <i class="bx bx-map me-2"></i>Tempat Cetak KTP
                                                </td>
                                                <td class="text-black"><?php echo e($penduduk->tempat_cetak_ktp ?? '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-primary">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <p class="card-text text-black"><?php echo e($penduduk->note ?? '-'); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/arifrizal/Desktop/bckup/website-kelurahan/resources/views/penduduk/show.blade.php ENDPATH**/ ?>